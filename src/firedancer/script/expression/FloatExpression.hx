...
abstract FloatExpression(
	...
	@:op(A + B) static extern inline function add(a: FloatExpression, b: FloatExpression): FloatExpression
		return a.add(b);

	@:commutative
	@:op(A + B) static extern inline function addFloat(a: FloatExpression, b: Float): FloatExpression
		return add(a, b);

	@:commutative
	@:op(A + B) static extern inline function addInt(a: FloatExpression, b: Int): FloatExpression
		return add(a, b);
